...
{
    public partial class FormRutLaiTruocHan : Form
    {
        ...
        DataTable tb = null;
        public FormRutLaiTruocHan()
        {
            InitializeComponent();
        }
        public FormRutLaiTruocHan(string maGiaoDich, string MaKhachHang, string MaNhanVien)
        {
            InitializeComponent();
        ...
        private void LoadData(string maGiaoDich)
        {
            ...
            tb = action.get_Chitiet_GiaoDichRutTruocHan(maGiaoDich).Tables[0];
            bool tinhTrang;
            ...
            txtSoNgay.Text = tb.Rows[0]["SoNgayThucGui"].ToString() + " ngày";
        ...
        {
            string err = "Check";
            bool thanhtoan = action.XacNhanRutLaiTruocHan(txtMaSo.Text, manhanvien, DateTime.Today.ToShortDateString(), makhachhang, ref err);
