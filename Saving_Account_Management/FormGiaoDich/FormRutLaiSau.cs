...
{
    public partial class FormRutLaiSau : Form
    {
        ...
        DataTable tb = null;
        public FormRutLaiSau()
        {
            InitializeComponent();
        }

        public FormRutLaiSau(string maGiaoDich, string MaKhachHang, string MaNhanVien)
        {
            InitializeComponent();
        ...
        {
            tb = action.get_Chitiet_GiaoDichRutLaiSau(maGiaoDich).Tables[0];
            bool tinhTrang;
            ...
            txtLai.Text = tb.Rows[0]["LaiSuatTK"].ToString();
        ...
        {
            string err = "Check";
            bool thanhtoan = action.ThanhToanTKS(txtMaSo.Text, manhanvien, DateTime.Today.ToShortDateString(), makhachhang, ref err);
            if (thanhtoan)
            {
