...
{
    public partial class FormRutLaiDinhKy : Form
    {
        ...
        DataTable tb = null;
        public FormRutLaiDinhKy()
        {
            InitializeComponent();
        }

        public FormRutLaiDinhKy(string maGiaoDich, string MaKhachHang, string MaNhanVien)
        {
            InitializeComponent();
        ...
        private void LoadData(string maGiaoDich)
        {
            ...
            tb = action.get_Chitiet_GiaoDichRutLaiDinhKy(maGiaoDich).Tables[0];
            bool tinhTrang;
            ...
            txtLaiNhan.Text = tb.Rows[0]["SoTienLai"].ToString();
            ...
            txtKyNhanLai.Text = tb.Rows[0]["KyTraLai"].ToString();
        ...
        {
            string err = "Check";
            bool thanhtoan = action.ThanhToanTKDK(txtMaSo.Text, manhanvien , DateTime.Today.ToShortDateString(), makhachhang, ref err);
            if (thanhtoan)
            {
                ...
                MessageBox.Show("Thanh toán thất bại, check lỗi");
        }
    }
}
