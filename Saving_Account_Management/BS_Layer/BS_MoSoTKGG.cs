...
namespace Saving_Account_Management.BS_Layer
{
    class BS_MoSoTKGG
    {
        ...
        public bool ThemSoTKGuiGop(string MaKH, string TenKH, string ngaysinh, string SDT, string MaDinhDanh, string ngaycap, string noicap, string diachi, string imageFolderPath,
         float khoanGui, string maNhanvien, string ngayMoSo, string maLoaiTien, int kyHan,int hanguigop, string error, ref string err)
        {
